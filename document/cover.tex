...
%%% Edit author's name
%% Author's full name
\Author{Pedro Durval\\Polónia}

%%% Edit thesis title in Portuguese
%% Thesis Mandatory Title in Portuguese
\TitlePT{Deteção de Comportamentos Anómalos em Funções Serverless com Monitorização de System Calls}
...
\TitleEN{Detecting Anomalous Behavior in Serverless Functions with System Call Monitoring}
...
\Supervisor{Diogo Gomes}{associado}
...
\SupervisorMember{Pedro Escaleira}{auxiliar convidado}{do Departamento de Eletrónica, Telecomunicações e Informática}{da Universidade de Aveiro}{}

%%% Repeat the above declaration for additional
%%%  Supervisor members as many times as necessary.
%% Additional Supervisor members
\SupervisorMember{Vitor Cunha}{auxiliar convidado}{do Departamento de Eletrónica, Telecomunicações e Informática}{da Universidade de Aveiro}{}
